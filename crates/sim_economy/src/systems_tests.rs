...
pub(crate) fn world_with_firms(tables: &EconTables) -> World {
    ...
    world
        ...
        .expect("register");
    world
        .register::<core_ecs::sim_interface::HousingBook>()
        .expect("register");
    world
        .register::<core_ecs::sim_interface::Needs>()
        .expect("register");
    world
...
pub(crate) fn staff(world: &mut World, firm: core_ecs::Entity) -> core_ecs::Entity {
...
pub(crate) fn firm_entities(world: &World) -> Vec<core_ecs::Entity> {
    world
        .iter::<Firm>()
        .expect("query")
        .map(|(entity, _)| entity)
